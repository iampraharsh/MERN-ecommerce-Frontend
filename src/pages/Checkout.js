		...
		<div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
			<div className='grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-6'>
				<div className='lg:col-span-3'>
					<form className='bg-white pr-4 pb-5 mb-7'>
						<div className='space-y-12 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-8'>
							...
							<div className='border-b border-gray-900/10 pb-12'>
								...
								>
									{addresses.map((address) => (
										<li
											key={address.email}
											className='flex justify-between gap-x-6 px-3 py-5 border-solid border-2 border-gray-100'
										>
				...
				<div className='lg:col-span-3'>
					...
					<div className='mx-auto bg-white max-w-7xl px-4 sm:px-6 lg:px-8'>
						<div className='mt-8 border-t border-gray-200 px-4 py-6 sm:px-6'>
							<h1 className='text-3xl  mt-5 mb-8 font-bold tracking-tight text-gray-900'>
								Cart
							</h1>
